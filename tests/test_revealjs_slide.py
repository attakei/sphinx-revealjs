...
class Test_BuildHtml:  # noqa
    ...
    def test_override_theme(self, app, status, warning):  # noqa
    ...
    @pytest.mark.sphinx("revealjs", testroot="misc")
    def test_override_font(self, app, status, warning):  # noqa
    ...
    @pytest.mark.sphinx("revealjs", testroot="misc")
    def test_config(self, app, status, warning):  # noqa
    ...
    @pytest.mark.sphinx("revealjs", testroot="misc")
    def test_config_as_content(self, app, status, warning):  # noqa
